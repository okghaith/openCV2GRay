...
//            myReader.close();
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                sms.sendTextMessage("+64211484398", null, "Help! I've met with an accident at http://maps.google.com/?q="+String.valueOf(latitude)+","+String.valueOf(longitude), null, null);
...
//                sms.sendTextMessage(No2, null, "Nearby Hospitals http://maps.google.com/maps?q=hospital&mrt=yp&sll="+String.valueOf(latitude)+","+String.valueOf(longitude)+"&output=kml", null, null);
                //longlat.setText(String.valueOf(longitude) + " ,"+ String.valueOf(latitude));
               // System.exit(1);
            }
        }, 15000);
    ...
    public void onLocationChanged(Location location){
        ...
        longlat.setText(String.valueOf(latitude) + " ,"+ String.valueOf(longitude));
